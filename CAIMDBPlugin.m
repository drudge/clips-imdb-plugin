...
#import "CAIMDBPlugin.h"
#import "CAIMDBMovieGrabber.h"

@implementation CAIMDBPlugin
...
+ (CARelevance)relevanceForPivot:(CAPivot *)pivot
{
	...
	if ([CAIMDBMovieGrabber hasExpectedPrefix:dt.string]) {
...
- (void)copyClip:(CAClip *)clip
{
	...
	CAIMDBMovieGrabber *grabber = [[CAIMDBMovieGrabber alloc] initWithString:dt.string];
